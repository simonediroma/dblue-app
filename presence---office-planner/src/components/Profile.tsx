    ...
    <motion.div initial="{{" opacity:="" 0,="" y:="" 10="" }}="" animate="{{" opacity:="" 1,="" y:="" 0="" }}="" exit="{{" opacity:="" 0,="" y:="" -10="" }}="" classname="flex flex-col items-center max-w-lg mx-auto w-full">
      ...
      <div classname="space-y-12 w-full px-2 pb-10">
        ...
        <section>
          ...
          <div classname="flex flex-col gap-3">
            <button classname="w-full bg-surface-container-lowest rounded-2xl p-4 flex items-center justify-center gap-3 transition-all duration-200 border border-outline-variant/10 hover:bg-red-50 active:scale-[0.98] shadow-sm text-red-600">
