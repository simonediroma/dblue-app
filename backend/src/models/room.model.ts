...
const DEFAULT_ROOMS: Array<{
  ...
  { name: 'Red', type: 'open_space', capacity: 4, color: '#ef4444' },
  { name: 'Green', type: 'open_space', capacity: 4, color: '#22c55e' },
  { name: 'Blue', type: 'open_space', capacity: 4, color: '#3b82f6' },
  { name: 'DBLue Innovation Lab', type: 'lab', capacity: 4, color: '#a855f7', visibleRoles: ['lab_responsible'] },
  { name: 'Admin Room', type: 'admin', capacity: 4, color: '#6366f1', visibleRoles: ['admin_member'] },
